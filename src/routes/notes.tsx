...
export const Route = createFileRoute('/notes')({
  ...
  validateSearch: (search: Record<string, unknown>) => {
    return {
      ...
      dateFilter: (search.dateFilter === 'all' || search.dateFilter === 'today' || search.dateFilter === 'week' || search.dateFilter === 'month' ? search.dateFilter : undefined) as 'all' | 'today' | 'week' | 'month' | undefined,
